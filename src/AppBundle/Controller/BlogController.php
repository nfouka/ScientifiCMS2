...
class BlogController extends Controller
{
     ...
     *
     * @Route("/d3js", name="d3js")
     * @Method("GET")
     */
    public function ResponseJsonAction(EventDispatcherInterface $eventDispatcher )
    {
     ...
     *     the route name and therefore, without breaking any existing link.
     *
     * @Route("/d3jsEvent", name="d3js2")
     * @Method("GET")
     */
    public function WgetAction()
    {
        return $this->render('blog/d3js.html.twig', [
        ]);
