...
class UserFixtures extends AbstractFixture implements ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $janeAdmin = new User();
        $janeAdmin->setFullName('Nadir Fouka');
        $janeAdmin->setUsername('nfouka');
        $janeAdmin->setEmail('nadir.fouka@gmail.com');
        $janeAdmin->setRoles(['ROLE_ADMIN']);
        $encodedPassword = $passwordEncoder->encodePassword($janeAdmin, 'lonelyness');
